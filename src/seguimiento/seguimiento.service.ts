...
export class SeguimientoService {
  ...
  constructor(
    ...
    @InjectRepository(Cita) private readonly citaRespository: Repository<Cita>
    ){}

  async create(createSeguimientoDto: CreateSeguimientoDto) {
    const cita = await this.citaRespository.findOneBy({cita_id: createSeguimientoDto.cita});
